...
interface WebmasterSidebarProps {
 // Hapus props isCollapsed dan setIsCollapsed karena tidak dibutuhkan lagi
}
...
const webmasterLinks = [
 {name: "Dashboard", path: "/admin/webmaster", icon: <MdDashboard />},
 {
  ...
  subItems: [
   ...
   {name: "Pricing", path: "/admin/webmaster/subscriptions/pricing"},
  ],
 },
 {
  name: "Clients",
  ...
  subItems: [
   ...
   {name: "Add New", path: "/admin/webmaster/clients/new"},
  ],
 },
 {
  name: "Resources",
...
export default function WebmasterSidebar({}: WebmasterSidebarProps) {
